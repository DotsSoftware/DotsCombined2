...
class BusinessSitePage extends StatefulWidget {
  @override
  _BusinessSitePageState createState() => _BusinessSitePageState();
}

class _BusinessSitePageState extends State<BusinessSitePage> {
  ...
  Future<void> _pickDocument(String fieldName) async {
    ...
    if (result != null) {
      ...
      // Use the provided Firebase Storage URL
      String storagePath =
          'https://console.firebase.google.com/u/6/project/fir-builds-eac7a/storage/fir-builds-eac7a.appspot.com/files/~2FDOTSCLIENTS/${user!.email}/${result.files.first.name}';

      // You can directly use the URL as a reference
